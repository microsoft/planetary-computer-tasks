...
class TaskRunRecordTable(RunRecordTable[TaskRunRecord]):
    ...
    def get_run_record_id(self, run_id: str, job_id: str, task_id: str) -> RunRecordId:
...
class WorkflowRunRecordTable(RunRecordTable[WorkflowRunRecord]):
    ...
    def get_run_record_id(self, dataset: DatasetIdentifier, run_id: str) -> RunRecordId:
    ...
    def _get_key_from_record(self, record: WorkflowRunRecord) -> Tuple[str, str]:
        return (record.dataset.as_key(), record.run_id)
    ...
    def get_workflow_runs(self, dataset: DatasetIdentifier) -> List[WorkflowRunRecord]:
